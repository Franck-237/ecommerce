                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    @foreach(Cart::content() as $item)
                                        <tr>
                                            <td class="image product-thumbnail"><img src="{{ ('assets/imgs/shop/product-') }}{{$item->model->id}}-1.jpg" alt="#"></td>
                                            <td class="product-des product-name">
                                                <h5 class="product-name"><a href="product-details.html">{{$item->model->name}}</a></h5>
                                                {{--<p class="font-xs">Maboriosam in a tonto nesciung eget<br> distingy magndapibus.
                                                </p>--}}
                                            </td>
                                            <td class="price" data-title="Price"><span>Fcfa {{$item->model->regular_price}}</span></td>
                        ...
                        <div class="cart-action text-end">
                            <a class="btn  mr-10 mb-sm-15"><i class="fi-rs-shuffle mr-10"></i>Modifier le panier</a>
                        ...
                        <div class="row mb-50">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <form class="field_form shipping_calculator">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-lg-12">
                                            <button class="btn  btn-sm"><i class="fi-rs-shuffle mr-10"></i>Modifier</button>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="border p-md-4 p-30 border-radius cart-totals">
                                    ...
                                    <a href="checkout.html" class="btn "> <i class="fi-rs-box-alt mr-10"></i> Procéder à l'achat</a>
                                </div>
                            </div>
                        </div>
                    </div>
