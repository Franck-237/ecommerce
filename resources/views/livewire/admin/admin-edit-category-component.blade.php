                            ...
                            <div class="card-body">
                                ...
                                <form action="" wire:submit.prevent="updateCategory">
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="name" id="" class="form-control" placeholder="Nom de la catégorie" wire:model="name" wire:keyup="generateSlug">
                                        @error('name')
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" name="slug" id="" class="form-control" placeholder="Titre de la catégorie" wire:model="slug">
                                        @error('slug')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
