                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{route('register')}}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="" name="name" placeholder="Votre nom" :value="old('name')" required autofocus autocomplete="name">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input required="" type="password" name="password_confirmation" placeholder="Confirmation de mot de passe" required autocomplete="new-password">
                                            </div>
                                            <div class="login_footer form-group">
                                                ...
                                                <a href="privacy-policy.html"><i class="fi-rs-book-alt mr-5 text-muted"></i>Plus de détails</a>
                                            </div>
                                            <div class="form-group">
